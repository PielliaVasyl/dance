...
class InstructorLocationForm(forms.ModelForm):
    class Meta:
...
class PlaceInMapForm(forms.ModelForm):
    class Meta:
        model = PlaceInMap
        fields = ["title", 'description', 'image', 'locations', 'place_types', "dance_styles", "author"]
...
class DanceShopForm(forms.ModelForm):
    class Meta:
        model = DanceShop
        fields = ["title", 'description', 'shop_types', 'photos', 'locations', 'links', 'contacts', "author"]
